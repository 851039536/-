...
官网对[组件名大小写](https://cn.vuejs.org/v2/guide/components-registration.html#组件名大小写)是这么介绍的，定义组件名的方式有两种：
...
<!--中划线-->
<p class="line-through ...">2 ...</p>
<!--无下划线-->
<a href="#" class="no-underline ...">3</a>
```
