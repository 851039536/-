...
如`.container-sm` 则只在sm屏幕下显示100%宽,其它断点包括`.container-md`、 `.container-lg`、 `.containerxl`
...
引入 Bootstrap 和BootstrapVue的`css` 
...
通过在`<b-row>`上设置`no-gutters`属性来删除 `<b-row>` 的边距和`<b-col>`的`padding`。
...
<div class="bg-gray-200 p-4">
  ...
  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam venenatis et lorem sit amet vehicula. Etiam vel nibh nec nisi euismod mollis ultrices condimentum velit. Proin velit libero, interdum ac rhoncus sit amet, pellentesque ac turpis. Quisque ac luctus turpis, vel efficitur ante. Cras convallis risus vel vehicula .</p>
</div>
```

##### 2.用于`.float-left`将元素浮动到其容器的左侧。
...
##### 3.使用`.float-none`重置应用到一个元素的任何浮动。这是float属性的默认值。
...
<div class="bg-gray-200 p-4">
  ...
  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam venenatis et lorem sit amet vehicula. Etiam vel nibh nec nisi euismod mollis ultrices condimentum velit. Proin velit libero, interdum ac rhoncus sit amet, .</p>
</div>
```
...
##### 1.用于`clear-left`将元素放置在任何先前的左浮动元素下方。
...
<div class="bg-gray-200 p-4">
  ...
  <img class="float-right ml-4 my-2 h-32" src="https://images.unsplash.com/photo-1459262838948-3e2de6c1ec80?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80">
  <p class="clear-left">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam venenatis et lorem sit amet vehicula. Etiam vel nibh nec nisi euismod mollis ultrices condimentum velit. Proin velit libero, interdum efficitur odio eu, finibus justo. Etiam eu vehicula felis.</p>
</div>
```

##### 2.用于`clear-right`将元素放置在任何先前的右上浮动元素下方。

```html
<div class="bg-gray-200 p-4">
  <img class="float-left mr-4 my-2 h-24" src="https://images.unsplash.com/photo-1459262838948-3e2de6c1ec80?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80">
  <img class="float-right ml-4 my-2 h-32" src="https://images.unsplash.com/photo-1459262838948-3e2de6c1ec80?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80">
  <p class="clear-right">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam venenatis et lorem sit amet vehicula. Etiam vel nibh nec nisi euismod mollis ultrices condimentum velit. Proin velit libero, interdum ac rhoncus sit amet, pellentesque ac turpis. Quisque ac luctus turpis, vel efficitur ante. Cras convallis risus vel vehicula dapibus. Donec eget neque fringilla, efficitur odio eu, finibus justo. Etiam eu vehicula felis.</p>
</div>
```

##### 3.用于`clear-both`将元素放置在所有之前的浮动元素下方。

```html
<div class="bg-gray-200 p-4">
  <img class="float-left mr-4 my-2 h-24" src="https://images.unsplash.com/photo-1459262838948-3e2de6c1ec80?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80">
  <img class="float-right ml-4 my-2 h-32" src="https://images.unsplash.com/photo-1459262838948-3e2de6c1ec80?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80">
  <p class="clear-both">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam venenatis et lorem sit amet vehicula. Etiam vel nibh nec nisi euismod mollis ultrices condimentum velit. Proin velit libero, interdum efficitur odio eu, finibus justo. Etiam eu vehicula felis.</p>
</div>
```

##### 4.使用`clear-none`重置应用到一个元素的任何清零。这是clear属性的默认值。

```html
<div class="bg-gray-200 p-4">
  <img class="float-left mr-4 my-2 h-24" src="https://images.unsplash.com/photo-1459262838948-3e2de6c1ec80?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80">
  <img class="float-right ml-4 my-2 h-32" src="https://images.unsplash.com/photo-1459262838948-3e2de6c1ec80?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80">
  <p class="clear-none">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam venenatis et lorem sit amet vehicula. Etiam vel nibh nec nisi euismod mollis felis.</p>
</div>
```
...
1.使用`.{top|right|bottom|left|inset}-0`实用程序将绝对定位的元素锚定在最接近定位的父对象的任何边缘上。

结合Tailwind的padding和margin工具，您可能会发现这些都是精确控制绝对定位的元素所需要的。
...
1.使用`.z-{index}`实用程序控制Tailwind中元素的堆栈顺序（或三维定位），无论其显示顺序如何。
...
```c#
 Scaffold-DbContext "server=localhost;userid=root;pwd=woshishui;port=3306;database=snblog;sslmode=none;" Pomelo.EntityFrameworkCore.MySql -OutputDir Models -Tables "SnArticle,SnUser" -Force     
```
